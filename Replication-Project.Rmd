...
stargazer(model_a, model_b, model_c, model_d,
          ...
          omit = c("gender", "blockid", "enum", "descriptives.age",  
                   ...
                   "Constant"),
          # column.labels = c("Outcome: Purchased at all", 
          #                   "Outcome: Purchased with Delay"),
...
serving a role of signalling that the seller is serious about their business
...
deal with sellers signalled their political connections (for similar reasons
discussed above).
...
and offering formal contracts) affect buyers' willingness to purchase goods
...
--for extension, code probit and logit, compare to OLS-- maybe put tables there
we need logit and probit for binary because the errors are wrong for OLS (+ it
gives us heteroscadcity; stuffed gets overexaggerated)--

limitations -- should have controlled for something? demostrate the brain is
exercising
