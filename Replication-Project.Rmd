...
a municpal council in Senegal. Afterwards, his employees began
official employment.
...
wouldn't confer and influence each others' responses).
...
model_b_data <- subset(data_factored, select = c("pool_T1", "pool_T2", "gender", "blockid",
                                                 "enum", "descriptives.age", "employed",
                                                 "student", "educ_level","coethnicreligion", "purchased",
                                                 "subscription_trust")) %>%
  mutate(T1 = pool_T1,
         T2 = pool_T2)
...
stargazer(model_1, model_2, model_3, model_4, model_5, model_6, model_7,
          ...
          covariate.labels = c("Political connection signaled",
                               "Formal contract",
                               "Political connection signal x formal contract"),
